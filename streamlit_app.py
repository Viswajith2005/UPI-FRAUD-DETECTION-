...
<div style='text-align:center; padding:0.5rem 0;'>
    ...
    <a href='https://www.linkedin.com/in/viswajith-gupta-telagamsetty-1b71812a2/' target='_blank' style='margin-right:12px;'>
        <img src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg' width='28' style='margin-top:4px;'/>
    </a>
    <a href='https://github.com/Viswajith2005' target='_blank'>
        <img src='https://raw.githubusercontent.com/gauravghongde/social-icons/master/PNG/Color/Github.png' width='28' style='margin-top:4px;'/>
    </a>
</div>
""", unsafe_allow_html=True)
    st.markdown("---")
